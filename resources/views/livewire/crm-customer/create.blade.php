<form wire:submit.prevent="submit" class="pt-3">
    ...
    <div class="form-group {{ $errors->has('crmCustomer.cf') ? 'invalid' : '' }}">
        <label class="form-label" for="cf">{{ trans('cruds.crmCustomer.fields.cf') }}</label>
        <input class="form-control" type="text" name="cf" id="cf" wire:model.defer="crmCustomer.cf">
        <div class="validation-message">
            {{ $errors->first('crmCustomer.cf') }}
        </div>
        <div class="help-block">
            {{ trans('cruds.crmCustomer.fields.cf_helper') }}
        </div>
    </div>
    <div class="form-group {{ $errors->has('crmCustomer.piva') ? 'invalid' : '' }}">
        <label class="form-label" for="piva">{{ trans('cruds.crmCustomer.fields.piva') }}</label>
        <input class="form-control" type="text" name="piva" id="piva" wire:model.defer="crmCustomer.piva">
        <div class="validation-message">
            {{ $errors->first('crmCustomer.piva') }}
        </div>
        <div class="help-block">
            {{ trans('cruds.crmCustomer.fields.piva_helper') }}
        </div>
    </div>
