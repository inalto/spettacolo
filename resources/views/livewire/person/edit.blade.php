<form wire:submit.prevent="submit" class="pt-3">
    ...
    <div class="w-1/2 form-group {{ $errors->has('person.city') ? 'invalid' : '' }}">
    ...
    <div class="w-1/2 form-group {{ $errors->has('person.cf') ? 'invalid' : '' }}">
    ...
    <div class="w-1/2 form-group {{ $errors->has('person.piva') ? 'invalid' : '' }}">
    ...
    <div class="w-1/2 form-group {{ $errors->has('contract') ? 'invalid' : '' }}">
